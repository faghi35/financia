        ...
        <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-light-100 flex items-center justify-center p-4">
            <div className="w-full max-w-md">
                <div className="text-center mb-8">
                    ...
                    <p className="text-secondary-500 mt-2">Gérez vos finances simplement</p>
                </div>

                <div className="bg-white rounded-2xl shadow-xl p-8 border border-light-200">
                    {/* <div className="flex mb-8 bg-light-100 rounded-xl p-1">
                        <button
                            ...
                            className={`flex-1 py-3 rounded-lg font-semibold transition-all duration-300 ${isLogin
                                ...
                                : 'text-secondary-500 hover:text-dark-700'
                                }`}
                        >
                            Connexion
                        </button>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-12 pr-4 py-4 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all outline-none"
                                        required={!isLogin}
                                    />
                                </div>
                            </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    placeholder="••••••••"
                                    className="w-full pl-12 pr-12 py-4 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all outline-none"
                                    required
                                    minLength={6}
                                />
                                <button
                        ...
                        <button
                            ...
                            className={`w-full py-4 rounded-xl font-semibold text-white transition-all duration-300 btn-press ${loading
                                ...
                                : 'gradient-primary hover:shadow-xl transform hover:-translate-y-0.5'
                                }`}
                        >
                            {loading ? (
